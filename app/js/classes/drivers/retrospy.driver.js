...
class RetroSpyDriver {
    ...
    setActive(port, device) {
        ...
        this.socket = new SerialPort(this.port, {
            baudRate: this.baud,
            autoOpen: true
        }, (function (err) {
            if (err) {
        ...
        const parser = this.socket.pipe(new Readline({
            delimiter: '\n'
        }))
    ...
    getDevices() {
        return [{
                value: 'nes',
                label: 'Nintendo Famicom (NES)'
            },
            {
                value: 'snes',
                label: 'Nintendo Super Famicom (SNES)'
            },
            {
                value: 'smashbox',
                label: 'Hit Box Smash Box'
            },
            {
                value: 'n64',
                label: 'Nintendo 64'
            ...
            {
                value: 'md',
                label: 'Sega Master System / Mega Drive (Genesis)'
            }
        ];
    }
